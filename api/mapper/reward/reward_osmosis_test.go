	...
	}{
		{
			...
			args: args{
				...
				lg: types.ABCIMessageLog{MsgIndex: 0, Log: "", Events: []types.StringEvent{
					...
					{Type: "message", Attributes: []types.Attribute{{Key: "action", Value: "/cosmos.staking.v1beta1.MsgUndelegate"}, {Key: "sender", Value: "osmo1jv65s3grqf6v6jl3dp4t6c9t9rk99cd80yhvld"}, {Key: "sender", Value: "osmo1fl48vsnmsdzcv85q5d2q4z5ajdha8yu3aq6l09"}, {Key: "module", Value: "staking"}, {Key: "sender", Value: "osmo12d9lvpyfcq9cjcn6chty2yv27w22nye2qark47"}}},
					{Type: "transfer", Attributes: []types.Attribute{{Key: "recipient", Value: "osmo12d9lvpyfcq9cjcn6chty2yv27w22nye2qark47"}, {Key: "sender", Value: "osmo1jv65s3grqf6v6jl3dp4t6c9t9rk99cd80yhvld"}, {Key: "amount", Value: "1ibc/BE1BB42D4BE3C30D50B68D7C41DB4DFCE9678E8EF8C539F6E6A9345048894FCC,1373536uosmo"}, {Key: "recipient", Value: "osmo1tygms3xhhs3yv487phx3dw4a95jn7t7lfqxwe3"}, {Key: "sender", Value: "osmo1fl48vsnmsdzcv85q5d2q4z5ajdha8yu3aq6l09"}, {Key: "amount", Value: "10100000uosmo"}}},
