...
func TestMapper_MsgBeginRedelegate_Osmosis(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantRev: &rewstruct.Tx{Type: "MsgBeginRedelegate", Sender: []string{"osmo1jv65s3grqf6v6jl3dp4t6c9t9rk99cd80yhvld", "osmo1jv65s3grqf6v6jl3dp4t6c9t9rk99cd80yhvld"}, Recipient: []string{"osmo1m3esxfpc2qlk75jyjhfgyhma3std4cmvuwhrwt", "osmo1m3esxfpc2qlk75jyjhfgyhma3std4cmvuwhrwt"}, Delegator: "osmo1m3esxfpc2qlk75jyjhfgyhma3std4cmvuwhrwt", ValidatorSrc: "osmovaloper12rzd5qr2wmpseypvkjl0spusts0eruw2g35lkn", ValidatorDst: "osmovaloper1ej2es5fjztqjcd4pwa0zyvaevtjd2y5w37wr9t", Amounts: []*rewstruct.Amount{{Text: "954871uosmo", Currency: "uosmo", Numeric: []byte("\x0e\x91\xf7")}}, Rewards: []*rewstruct.Amount{{Text: "3111uosmo", Currency: "uosmo", Numeric: []byte("\x0c'")}, {Text: "3910uosmo", Currency: "uosmo", Numeric: []byte("\x0fF")}}},
		},
		// TODO: Add test cases.
	}
	for _, tt := range tests {
